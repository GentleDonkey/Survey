...
switch ($l10n->getLanguage()) {
    case 'en-CA':
    	...
    	$l10n->setKeyValuePair('thankYou1', ', thank you for your feedback for ');
    	$l10n->setKeyValuePair('thankYou2', ' of SASS!');
	...
	case 'fr-CA':
    	...
    	$l10n->setKeyValuePair('thankYou1', '(fr), thank you for your feedback for ');
    	$l10n->setKeyValuePair('thankYou2', '(fr) of SASS!');
